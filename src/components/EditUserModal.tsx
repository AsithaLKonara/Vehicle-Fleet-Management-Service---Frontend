...
import { XMarkIcon, UserIcon, EnvelopeIcon, IdentificationIcon, ShieldCheckIcon } from '@heroicons/react/24/outline';
          ...
          >
            <div className="flex justify-between items-start">
              <div className="space-y-1">
                <h2 className="text-3xl font-bold text-white tracking-tight">Modify <span className="gradient-text">Profile</span></h2>
                <p className="text-text-dim text-sm font-medium">Update operational clearance and identity metadata.</p>
              </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              {mutation.isError && (
                ...
                >
                  ...
                  Mutation failure. Ensure network connectivity and clearance.
                </motion.div>
              )}
